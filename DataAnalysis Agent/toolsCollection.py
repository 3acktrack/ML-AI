...
class ToolCollection:
    ...
    @tool
    def list_csv_files(self) -> Optional[List[str]]:
    ...
    @tool
    def preload_datasets(self, paths: List[str]) -> str:
        """
    ...
    @tool
    def get_dataset_summaries(self, dataset_paths: List[str]) -> List[Dict[str, Any]]:
        """
    ...
    @tool
    def call_dataframe_method(self, file_name: str, method: str) -> str:
       """
    ...
    @tool
    def evaluate_classification_dataset(self, file_name: str, target_column: str) -> Dict[str, float]:
        """
    ...
    @tool
    def evaluate_regression_dataset(self, file_name: str, target_column: str) -> Dict[str, float]:
        """
...
def unitTest():
    toolCol = ToolCollection()
    print (toolCol.list_csv_files.invoke(""))
